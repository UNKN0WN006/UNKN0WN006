...
<div align="center">
  <img src="./assets/github-solar-orbit.svg" width="100%" alt="GitHub Solar Orbit — current-year contribution activity"/>
</div>

<sub>Generated daily from GitHub contribution data. Earth marks today; the orbit itself is the year map.</sub>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./profile/developer-signal-dark.svg">
  <img src="./profile/developer-signal-light.svg" width="100%" alt="Developer signal dashboard">
</picture>
